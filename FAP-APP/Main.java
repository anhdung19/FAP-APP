...
public class Main {
    public static void main(String[] args) {
       ...
       // Adapter ========Structural1 Pattern
        ...
        DepartmentService departmentService = new DepartmentService("FPT BTEC");
        departmentService.addUnit(computerScience);
        departmentService.displayDetails();

        // Iterator ============Behavior1 ====================================================

        Student student1 = new Student(1,"Nguyen Manh Dung");
        Student student2 = new Student(2, "Nguyen Ton Chinh");
        Student student3 = new Student(3,"Nguyen Thu Phuong");
